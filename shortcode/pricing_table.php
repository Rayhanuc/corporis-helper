...
add_action( 'init', 'corporis_pricing_table_section' );
if(!function_exists('corporis_pricing_table_section')):

function corporis_pricing_table_section(){
	if(function_exists('kc_add_map')):
		kc_add_map(array(
			'corporis_pricing_table' => array(
				'name' 		=> esc_html__( 'Pricing Table', 'corporis' ),//translateable
				'icon' 		=> 'fa fa-fa',
...
function corporis_pricing_table_section_shor($atts,$content){
	ob_start();
		    ...
		    <div class="text-center u-MarginBottom35 u-Padding0">
		        <div class="u-BoxShadow100">
		            <div class="Blurb Blurb--wrapper">
		                <h3 class="Blurb__hoverText u-MarginTop0"><?php echo esc_html($title);?></h3>
		                ...
		                <small class="Blurb__hoverText text-muted text-uppercase"><?php echo esc_html($text1);?></small>
		                ...
		                <a class="Blurb__hoverBtn btn btn-default u-Rounded" href="#"><?php echo esc_html($text6);?></a>
		            </div>
		        </div>
		    </div>
	    </div>
...
add_shortcode( 'corporis_pricing_table', 'corporis_pricing_table_section_shor' );
